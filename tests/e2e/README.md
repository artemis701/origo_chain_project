...
# by defaullt './build/.exad:/root/.exad'
...
5. After block `50` is reached, the test suite exports `/.exad` folder from docker container to local `build/` and than purge the container.
...
```log
            	Error:      	Received unexpected error:
            	            	...
            	            	main.appCreator.newApp({{{0x3399b40, 0xc000ec1db8}, {0x33ac0f8, 0xc0011314e0}, {0x33a2920, 0xc000ed2b80}, 0xc0000155f0}}, {0x3394520, 0xc001633bc0}, {0x33a5cc0, ...}, ...)
            	            		github.com/evmos/evmos/v10/cmd/exad/root.go:243 +0x2ca
            	            	...
            	            	main.main()
            	            		github.com/evmos/evmos/v10/cmd/exad/main.go:20 +0x45
