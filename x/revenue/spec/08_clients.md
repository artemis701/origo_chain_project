...
Find below a list of  `exad` commands added with the  `x/revenue` module. You can obtain the full list by using the `exad -h` command. A CLI command can look like this:

```bash
exad query revenue params
```
