...
origod tx revenue register $CONTRACT $NONCE $WITHDRAWER \
...
```bash
# Check revenues
origod q revenue contract $CONTRACT
```
...
origod tx revenue update $CONTRACT $WITHDRAWER \
...
origod tx revenue cancel $CONTRACT \
--gas=700000 --gas-prices=10000pose \
--from=mm
```
